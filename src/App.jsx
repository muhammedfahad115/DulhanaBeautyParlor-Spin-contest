    ...
    <>
      <div>
        <div className="w-screen h-screen bg-cover bg-no-repeat bg-center flex items-center justify-center" style={{ backgroundImage: `url(${img})` }}>
          <div className="flex flex-col sm:flex-row md:w-3/4 h-4/5 sm:h-5/6 items-center justify-between gap-4 p-4 sm:mx-auto">
            <div className="w-[300px] h-auto sm:h-96 bg-yellow-900 opacity-65 rounded-lg p-4 flex flex-col justify-between">
